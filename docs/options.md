...
```nix
"/nix/store/7i0a8wwmjd0107sgv7fwz6x0mv7f04aj-tmux/bin/tmux"
```
...
*Declared by:*
 - [/nix/store/0ph01z44xvnkprarlgy0ya9cf02fnglx-source/base/stylix\.nix](/nix/store/0ph01z44xvnkprarlgy0ya9cf02fnglx-source/base/stylix.nix)
