...
```nix
"/nix/store/47ldssxz80adkd8s7lr6r5a4wckm9k04-tmux/bin/tmux"
```
...
*Declared by:*
 - [/nix/store/1a4zs3gispigydgfcqzhyq9hlwkqmi6a-source/base/stylix\.nix](/nix/store/1a4zs3gispigydgfcqzhyq9hlwkqmi6a-source/base/stylix.nix)
