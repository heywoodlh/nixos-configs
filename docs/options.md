...
*Declared by:*
 - [/nix/store/sgz7havxmw7j3lj7vxbsf2dda4ldws56-source/base/defaults\.nix](/nix/store/sgz7havxmw7j3lj7vxbsf2dda4ldws56-source/base/defaults.nix)
...
```nix
"/nix/store/v60hzccpxm1jglrz61ncxgysaby18xn2-tmux/bin/tmux"
```
...
*Declared by:*
 - [https://tangled.org/heywoodlh.io/nixos-configs/blob/main/home/modules/hypr-rdp\.nix](https://tangled.org/heywoodlh.io/nixos-configs/blob/main/home/modules/hypr-rdp.nix)



## heywoodlh\.home\.hypr-rdp\.enable



Whether to enable hypr-rdp (RDP server for Hyprland)\.
...
## heywoodlh\.home\.hypr-rdp\.package
...
*Default:*
the hypr-rdp package with a corrected cargo vendor hash
...
## heywoodlh\.home\.llm\.opencode\.vllm



Enable local vllm + OpenCode\.
...
## heywoodlh\.home\.llm\.opencode\.vllm\.extraArgs
...
```nix
"--max-model-len 8192 --max-num-batched-tokens 8192 --gpu-memory-utilization 0.50 --tool-call-parser openai --enable-auto-tool-choice"
```
...
## heywoodlh\.home\.llm\.opencode\.vllm\.model



Local model to pull in vllm\.
...
## heywoodlh\.home\.llm\.opencode\.vllm\.model\.alias
...
## heywoodlh\.home\.llm\.opencode\.vllm\.model\.contextTokens
...
## heywoodlh\.home\.llm\.opencode\.vllm\.model\.name
...
## heywoodlh\.home\.llm\.opencode\.vllm\.model\.outputTokens
...
## heywoodlh\.home\.llm\.opencode\.vllm\.name
...
## heywoodlh\.home\.llm\.opencode\.vllm\.port
...
## heywoodlh\.home\.llm\.pi



Enable pi-coding-agent configuration\.
...
## heywoodlh\.home\.llm\.pi\.extensions
...
## heywoodlh\.home\.llm\.pi\.extraConf
...
## heywoodlh\.home\.paseo\.extraConf
...
## heywoodlh\.luks\.keyfile\.timeout
...
## heywoodlh\.nixos\.gaming\.console
...
## heywoodlh\.nixos\.gaming\.soulframe
...
## heywoodlh\.nixos\.portmaster\.enable



Enable the Portmaster application firewall\.
...
*Declared by:*
 - [https://tangled.org/heywoodlh.io/nixos-configs/blob/main/nixos/modules/portmaster\.nix](https://tangled.org/heywoodlh.io/nixos-configs/blob/main/nixos/modules/portmaster.nix)
...
## heywoodlh\.nixos\.portmaster\.extraConf



Extra configuration merged into ` services.portmaster `\.
...
## heywoodlh\.nixos\.portmaster\.profilePrefix



Prefix added to the display name of every declarative Portmaster profile\.
...
## heywoodlh\.nixos\.sunshine\.dynamic
...
## heywoodlh\.nixos\.sunshine\.resolutions
...
*Declared by:*
 - [/nix/store/sgz7havxmw7j3lj7vxbsf2dda4ldws56-source/base/sshd\.nix](/nix/store/sgz7havxmw7j3lj7vxbsf2dda4ldws56-source/base/sshd.nix)
...
*Declared by:*
 - [/nix/store/sgz7havxmw7j3lj7vxbsf2dda4ldws56-source/base/stylix\.nix](/nix/store/sgz7havxmw7j3lj7vxbsf2dda4ldws56-source/base/stylix.nix)
