    ...
    in {
      packages = {
        ...
        fleetdm = mkKubeDrv "fleetdm" {
          ...
          namespace = "monitoring";
          image = "docker.io/fleetdm/fleet:v4.80.1";
        ...
        grafana = mkKubeDrv "grafana" {
          ...
          namespace = "monitoring";
          image = "docker.io/grafana/grafana:11.6.10";
        ...
        immich-machine-learning = mkKubeDrv "immich-machine-learning" {
          ...
          namespace = "default";
          timezone = "America/Denver";
          image = "ghcr.io/immich-app/immich-machine-learning:v2.5.5-openvino";
          replicas = 1;
        ...
        miniflux = mkKubeDrv "miniflux" {
          ...
          namespace = "default";
          image = "docker.io/miniflux/miniflux:2.2.16";
        ...
        open-webui = mkKubeDrv "open-webui" {
          ...
          webui_image = "ghcr.io/open-webui/open-webui:0.7.2";
          ollama_image = "docker.io/ollama/ollama:0.15.6";
        ...
        samplicator = mkKubeDrv "samplicator" {
          ...
          kubectl_image = "docker.io/heywoodlh/kubectl:v1.35.0";
          replicas = 1;
        };
        ...
        tor-socks-proxy = mkKubeDrv "tor-socks-proxy" {
          ...
          namespace = "default";
          image = "docker.io/heywoodlh/tor-socks-proxy:0.4.8.22";
          replicas = 1;
        };
