    ...
    in {
      packages = {
        ...
        fleetdm = mkKubeDrv "fleetdm" {
          ...
          namespace = "monitoring";
          image = "docker.io/fleetdm/fleet:v4.80.2";
        ...
        grafana = mkKubeDrv "grafana" {
          ...
          namespace = "monitoring";
          image = "docker.io/grafana/grafana:11.6.11";
        ...
        miniflux = mkKubeDrv "miniflux" {
          ...
          postgres_image = "docker.io/postgres:15.16";
          postgres_replicas = 1;
          nodename = "homelab";
        ...
        open-webui = mkKubeDrv "open-webui" {
          ...
          webui_image = "ghcr.io/open-webui/open-webui:v0.8.1";
          ollama_image = "docker.io/ollama/ollama:0.16.1";
