    ...
    in {
      packages = {
        ...
        fleetdm = mkKubeDrv "fleetdm" {
          ...
          namespace = "monitoring";
          image = "docker.io/fleetdm/fleet:v4.82.0";
        ...
        grafana = mkKubeDrv "grafana" {
          ...
          namespace = "monitoring";
          image = "docker.io/grafana/grafana:11.6.13";
        ...
        media = mkKubeDrv "media" {
          ...
          replicas = 1;
          media_uid = "995";
          plex_image = "docker.io/linuxserver/plex:1.43.0";
          ...
          tautulli_image = "docker.io/tautulli/tautulli:v2.16.1";
        ...
        miniflux = mkKubeDrv "miniflux" {
          ...
          namespace = "default";
          image = "docker.io/miniflux/miniflux:2.2.17";
        ...
        ollama = mkKubeDrv "ollama" {
          ...
          image = "docker.io/ollama/ollama:0.18.0";
        ...
        open-webui = mkKubeDrv "open-webui" {
          ...
          ollama_image = "docker.io/ollama/ollama:0.18.0";
        ...
        protonmail-bridge = mkKubeDrv "protonmail-bridge" {
          ...
          ferroxide_image = "docker.io/heywoodlh/ferroxide:2026_03";
          nodename = "homelab";
        ...
        samplicator = mkKubeDrv "samplicator" {
          ...
          kubectl_image = "docker.io/heywoodlh/kubectl:v1.35.1";
          replicas = 1;
        };
        ...
        tor-socks-proxy = mkKubeDrv "tor-socks-proxy" {
          ...
          namespace = "default";
          image = "docker.io/heywoodlh/tor-socks-proxy:0.4.9.5";
          replicas = 1;
        };
