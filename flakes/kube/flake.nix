    ...
    in {
      packages = {
        ...
        flan-scan = mkKubeDrv "flan-scan" {
          ...
          http_image = "docker.io/heywoodlh/http-files:v2.11.1";
        ...
        fleetdm = mkKubeDrv "fleetdm" {
          ...
          namespace = "monitoring";
          image = "docker.io/fleetdm/fleet:v4.81.2";
        ...
        grafana = mkKubeDrv "grafana" {
          ...
          namespace = "monitoring";
          image = "docker.io/grafana/grafana:11.6.12";
        ...
        http-files = mkKubeDrv "http-files" {
          ...
          namespace = "default";
          image = "docker.io/heywoodlh/http-files:v2.11.1";
          replicas = 1;
        };
        ...
        nuclei = mkKubeDrv "nuclei" {
          ...
          interactsh_image = "docker.io/projectdiscovery/interactsh-server:v1.3.0";
        ...
        open-webui = mkKubeDrv "open-webui" {
          ...
          webui_image = "ghcr.io/open-webui/open-webui:v0.8.8";
          ollama_image = "docker.io/ollama/ollama:0.17.7";
