    ...
    in {
      packages = {
        ...
        dev = mkKubeDrv "dev" {
          ...
          namespace = "default";
          replicas = 1;
          image = "docker.io/heywoodlh/dev:2026_03_snapshot";
        };
        ...
        coder = mkKubeDrv "coder" {
          ...
          namespace = "coder";
          version = "2.8.3";
          image = "ghcr.io/coder/coder:v2.33.1";
        ...
        coredns = mkKubeDrv "coredns" {
          ...
          namespace = "coredns";
          image = "docker.io/coredns/coredns:1.14.3";
          replicas = "1";
        };
        ...
        flan-scan = mkKubeDrv "flan-scan" {
          ...
          http_image = "docker.io/heywoodlh/http-files:v2.11.2";
        ...
        fleetdm = mkKubeDrv "fleetdm" {
          ...
          namespace = "monitoring";
          image = "docker.io/fleetdm/fleet:v4.84.2";
          mysql_image = "docker.io/mysql:8.4.9";
        ...
        grafana = mkKubeDrv "grafana" {
          ...
          namespace = "monitoring";
          image = "docker.io/grafana/grafana:11.6.14";
          storageclass = "local-path";
        };
        grayjay = mkKubeDrv "grayjay" {
          src = ./templates/grayjay.yaml;
          namespace = "default";
          image = "docker.io/heywoodlh/grayjay:2026_05";
          nodename = "homelab";
        ...
        http-files = mkKubeDrv "http-files" {
          ...
          namespace = "default";
          image = "docker.io/heywoodlh/http-files:v2.11.2";
          replicas = 1;
        };
        ...
        media = mkKubeDrv "media" {
          ...
          replicas = 1;
          media_uid = "995";
          plex_image = "docker.io/linuxserver/plex:1.43.1";
          ...
          sonarr_image = "docker.io/linuxserver/sonarr:4.0.17-develop";
          ...
          tautulli_image = "docker.io/tautulli/tautulli:v2.17.1";
          tautulli_hostfolder = "/media/config/services/tautulli/config";
          qbittorrent_image = "docker.io/linuxserver/qbittorrent:5.2.0";
        ...
        miniflux = mkKubeDrv "miniflux" {
          ...
          postgres_image = "docker.io/postgres:15.17";
          postgres_replicas = 1;
          nodename = "homelab";
        ...
        nuclei = mkKubeDrv "nuclei" {
          ...
          namespace = "nuclei";
          image = "docker.io/heywoodlh/nuclei:v3.7.1";
          interactsh_image = "docker.io/projectdiscovery/interactsh-server:v1.3.1";
          httpd_image = "docker.io/httpd:2.4.67";
          replicas = 1;
        };
        ...
        ollama = mkKubeDrv "ollama" {
          ...
          image = "docker.io/ollama/ollama:0.23.1";
          hostfolder = "/media/data-ssd/ollama";
        };
        open-webui = mkKubeDrv "open-webui" {
          src = ./templates/open-webui.yaml;
          namespace = "open-webui";
          webui_image = "ghcr.io/open-webui/open-webui:v0.9.2";
          ollama_image = "docker.io/ollama/ollama:0.23.1";
        ...
        protonmail-bridge = mkKubeDrv "protonmail-bridge" {
          ...
          ferroxide_image = "docker.io/heywoodlh/ferroxide:2026_05";
          nodename = "homelab";
        ...
        redm = mkKubeDrv "redm" {
          ...
          mysql_image = "docker.io/mariadb:10.11.16";
        ...
        rsshub = mkKubeDrv "rsshub" {
          ...
          redis_image = "docker.io/redis:7.4.9";
          redis_replicas = 1;
          nodename = "homelab";
        ...
        samplicator = mkKubeDrv "samplicator" {
          ...
          kubectl_image = "docker.io/heywoodlh/kubectl:v1.36.0";
          replicas = 1;
        };
        ...
        syslog = mkKubeDrv "syslog" {
          ...
          image = "docker.io/linuxserver/syslog-ng:4.10.2";
        ...
        tailscale-mullvad-socks-router = mkKubeDrv "tailscale-mullvad-socks-router" {
          ...
          namespace = "default";
          image = "docker.io/heywoodlh/tailscale-mullvad-router:1.96.5";
          replicas = 1;
        ...
        tor-socks-proxy = mkKubeDrv "tor-socks-proxy" {
          ...
          namespace = "default";
          image = "docker.io/heywoodlh/tor-socks-proxy:0.4.9.6";
          replicas = 1;
        };
