    ...
    in {
      packages = {
        ...
        dev = mkKubeDrv "dev" {
          ...
          namespace = "default";
          replicas = 1;
          image = "docker.io/heywoodlh/dev:2026_02_snapshot";
        };
        ...
        coder = mkKubeDrv "coder" {
          ...
          namespace = "coder";
          version = "2.8.3";
          image = "ghcr.io/coder/coder:v2.30.2";
        ...
        fleetdm = mkKubeDrv "fleetdm" {
          ...
          namespace = "monitoring";
          image = "docker.io/fleetdm/fleet:v4.81.0";
        ...
        nuclei = mkKubeDrv "nuclei" {
          ...
          namespace = "nuclei";
          image = "docker.io/heywoodlh/nuclei:v3.7.0";
        ...
        open-webui = mkKubeDrv "open-webui" {
          ...
          webui_image = "ghcr.io/open-webui/open-webui:v0.8.5";
          ollama_image = "docker.io/ollama/ollama:0.17.4";
        ...
        protonmail-bridge = mkKubeDrv "protonmail-bridge" {
          ...
          ferroxide_image = "docker.io/heywoodlh/ferroxide:2026_02";
          nodename = "homelab";
