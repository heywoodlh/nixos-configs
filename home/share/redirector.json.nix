''
{
  ...
  "redirects": [
    ...
    },
    {
      ...
      "exampleResult": "http://teddit/r/AskReddit/comments/rr5izn/what_is_something_americans_will_never_understand/",
      "error": null,
      "includePattern": "(https://.*reddit.com)/(.*)",
      "excludePattern": "",
      "patternDesc": "Redirect all Reddit links to Teddit",
      "redirectUrl": "http://teddit/$2",
      "patternType": "R",
      "processMatches": "noProcessing",
      "disabled": false,
      "grouped": false,
